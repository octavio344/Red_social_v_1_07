...
public class ModificarDatos extends javax.swing.JFrame {
     ...
     */
    public ModificarDatos(Usuario u) {
        initComponents();
        this.u=u;
    }
    ...
    private void initComponents() {
        ...
        jTextField_UN.setBounds(250, 210, 170, 20);
        ...
        jButton2.setBounds(339, 447, 120, 39);

        RegisterJb.setFont(new java.awt.Font("Segoe Script", 3, 18)); // NOI18N
        RegisterJb.setText("Modificar");
    ...
    private void RegisterJbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterJbActionPerformed
       ...
       boolean b=false;
            ...
            if(String.valueOf(jPasswordField_PS.getPassword()).equals(String.valueOf(jPasswordField_CPS.getPassword()))){
               try {
               b=ni.modificarDatos(u,NombreFieldT.getText() ,jTextField_AP.getText(), jTextField_UN.getText(),String.valueOf(jPasswordField_PS.getPassword()),fnac ,jTextField1.getText() );
               this.u=ni.buscarPorId(u);
               MainMenu mnf=new MainMenu(u);
                mnf.setVisible(true);
                 mnf.pack();
                mnf.setLocationRelativeTo(null);
        ...
        if(b==true){
         JOptionPane.showMessageDialog(this, "El usuario "+u.getUsername()+" se modificico con exito!");
